...
ask_pen = turtle.Turtle()

def askReplay ():
    ask_pen.speed(0)
    ask_pen.color("red")
    ask_pen.penup()
    ask_pen.setposition(0, -50)
    askstring = "Replay?: Y / N"
    ask_pen.write(askstring, False, align="Center", font =("Comic Sans MS", 30, "normal"))
    ask_pen.hideturtle()
...
def nButtonPress ():
    ...
    bye.setposition(0, 0)
    byestring = "BYE"
    bye.write(byestring, False, align="Center", font =("Comic Sans MS", 100, "normal")) 
    bye.hideturtle()


#create keyboard bindings
turtle.listen()
turtle.onkey(yButtonPress, "Left")
turtle.onkey(nButtonPress, "Right")
